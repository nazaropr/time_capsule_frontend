...
import { createCapsule } from "@/app/(protected)/capsules/actions";
    ...
    <div className="max-w-2xl mx-auto py-8">
      <div className="mb-8">
        ...
        <p className="text-slate-400 mt-2">
          Seal your memories today, unlock them in the future.
        </p>
      </div>
        ...
        {state?.success ? (
          <div className="text-center py-12">
            ...
            <p className="text-slate-400 mb-8">
              It will remain locked until the designated time.
            </p>
            <Link
              href="/dashboard"
              className="btn-primary inline-flex md:w-auto px-8"
            >
              Go to Dashboard
            </Link>
          </div>
